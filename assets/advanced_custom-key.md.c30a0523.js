import{_ as n,c as s,o as a,a as t}from"./app.94291136.js";const x='{"title":"Custom storage key","description":"","frontmatter":{},"headers":[],"relativePath":"advanced/custom-key.md"}',e={},o=t(`<h1 id="custom-storage-key" tabindex="-1">Custom storage key <a class="header-anchor" href="#custom-storage-key" aria-hidden="true">#</a></h1><p>You can set a custom storage key by setting the <code>key</code> key in each strategy.</p><p>In this example, the whole state will be stored in the localStorage under the key <code>user</code>.</p><div class="language-typescript"><pre><code><span class="token comment">// store/use-user-store.ts</span>
