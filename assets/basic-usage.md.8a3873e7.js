import{_ as s,c as n,o as a,a as t}from"./app.94291136.js";const g='{"title":"Basic usage","description":"","frontmatter":{},"headers":[],"relativePath":"basic-usage.md"}',p={},e=t(`<h1 id="basic-usage" tabindex="-1">Basic usage <a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a></h1><p>By enabling the persist plugin on your store, the whole state will be stored in the uniAppStorage by default.</p><p>The store <code>id</code> is used as the storage key (to set a custom storage key)</p><div class="language-typescript"><pre><code><span class="token comment">// store/use-user-store.ts</span>
