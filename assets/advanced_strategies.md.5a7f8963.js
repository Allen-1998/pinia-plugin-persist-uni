import{_ as s,c as n,o as a,a as t}from"./app.e521951d.js";const g='{"title":"Strategies","description":"","frontmatter":{},"headers":[],"relativePath":"advanced/strategies.md"}',e={},p=t(`<h1 id="strategies" tabindex="-1">Strategies <a class="header-anchor" href="#strategies" aria-hidden="true">#</a></h1><p>With <code>pinia-plugin-persist-uni</code> You can use multiple strategies to persist your store data.</p><p>You can define a strategy list in your store under the <code>persist</code> key.</p><div class="language-typescript"><pre><code><span class="token comment">// store/use-user-store.ts</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
  ...
  key<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span> <span class="token comment">// Storage key</span>
  paths<span class="token operator">?</span><span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token comment">// list ok state keys you want to store in the storage</span>
<span class="token punctuation">}</span>
</code></pre></div>`,6),o=[p];function c(r,i,l,u,k,d){return a(),n("div",null,o)}var m=s(e,[["render",c]]);export{g as __pageData,m as default};
